...
class EmployeeSeeder extends Seeder
{
    ...
    {
        $this->call(TenagaKerjaAIL::class);
        $this->call(TenagaKerjaBillman::class);
        $this->call(TenagaKerjaGP::class);
        $this->call(TenagaKerjaOPGI::class);
        $this->call(TenagaKerjaPembangkit::class);
        $this->call(TenagaKerjaYantek::class);
